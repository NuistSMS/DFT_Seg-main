...
if __name__ == '__main__':
    ...
    checkpoint = torch.load('save_model/good/med/medseg-v1.ckpt', map_location='cpu')["state_dict"]
    ...
    if results:
        ...
        print("=" * 50)
        print(f" Test Dice : {res.get('test_dice', 0):.4f}  (Variance: {res.get('test_dice_var', 0):.5f})")
        print(f" Test MIoU : {res.get('test_MIoU', 0):.4f}  (Variance: {res.get('test_MIoU_var', 0):.5f})")
        print("=" * 50 + "\n")